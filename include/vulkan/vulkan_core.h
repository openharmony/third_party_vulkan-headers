...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_NATIVE_BUFFER_OHOS = 1000686001,
    VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_OHOS = 1000686002,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_OHOS = 1000686003,
    VK_STRUCTURE_TYPE_NATIVE_BUFFER_USAGE_OHOS = 1000687000,
    VK_STRUCTURE_TYPE_NATIVE_BUFFER_PROPERTIES_OHOS = 1000687001,
    VK_STRUCTURE_TYPE_NATIVE_BUFFER_FORMAT_PROPERTIES_OHOS = 1000687002,
    VK_STRUCTURE_TYPE_IMPORT_NATIVE_BUFFER_INFO_OHOS = 1000687003,
    VK_STRUCTURE_TYPE_MEMORY_GET_NATIVE_BUFFER_INFO_OHOS = 1000687004,
    VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_OHOS = 1000687005,
    // ---- OHOS Add----
